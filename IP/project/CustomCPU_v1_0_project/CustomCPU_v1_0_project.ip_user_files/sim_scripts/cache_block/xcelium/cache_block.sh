...
#
# Script generated by Vivado on Sun Jul 16 17:32:47 CEST 2023
...
#
# Usage        : cache_block.sh
#                cache_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cache_block.sh [-reset_run]
#                cache_block.sh [-reset_log]
#                cache_block.sh [-help]
#
...
#                script (type 'cache_block.sh -help' for more information).
#
...
# script info
echo -e "cache_block.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cache_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cache_block xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cache_block -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cache_block_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: cache_block.sh [-step]\n\
Usage: cache_block.sh [-lib_map_path]\n\
Usage: cache_block.sh [-reset_run]\n\
Usage: cache_block.sh [-reset_log]\n\
Usage: cache_block.sh [-keep_index]\n\
