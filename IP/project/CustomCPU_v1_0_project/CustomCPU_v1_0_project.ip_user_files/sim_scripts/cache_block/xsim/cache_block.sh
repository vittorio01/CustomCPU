...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot cache_block xil_defaultlib.cache_block -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cache_block -key {Behavioral:sim_1:Functional:cache_block} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cache_block.wdb xsim.dir libdpi.so)
