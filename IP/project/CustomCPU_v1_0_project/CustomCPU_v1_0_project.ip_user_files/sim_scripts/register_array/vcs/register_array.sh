...
#
# Script generated by Vivado on Mon Jul 17 18:12:29 CEST 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : register_array.sh
...
#
# Usage        : register_array.sh
#                register_array.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                register_array.sh [-reset_run]
#                register_array.sh [-reset_log]
#                register_array.sh [-help]
#
...
#                script (type 'register_array.sh -help' for more information).
#
...
# script info
echo -e "register_array.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./register_array.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.register_array xil_defaultlib.glbl -o register_array_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./register_array_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/vittorio/GitHub/CustomCPU/IP/project/CustomCPU_v1_0_project/CustomCPU_v1_0_project.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key register_array_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc register_array_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./register_array.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: register_array.sh [-help]\n\
Usage: register_array.sh [-step]\n\
Usage: register_array.sh [-lib_map_path]\n\
Usage: register_array.sh [-reset_run]\n\
Usage: register_array.sh [-reset_log]\n\
Usage: register_array.sh [-keep_index]\n\
Usage: register_array.sh [-noclean_files]\n\n\
