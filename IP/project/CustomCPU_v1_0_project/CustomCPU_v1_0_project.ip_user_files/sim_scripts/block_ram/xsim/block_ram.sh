...
#
# Script generated by Vivado on Mon Jul 17 18:04:41 CEST 2023
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot block_ram xil_defaultlib.block_ram -log elaborate.log
}
