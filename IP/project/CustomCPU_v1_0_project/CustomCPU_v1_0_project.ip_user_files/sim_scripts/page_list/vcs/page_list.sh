...
#
# Script generated by Vivado on Mon Jul 24 18:37:20 CEST 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : page_list.sh
...
#
# Usage        : page_list.sh
#                page_list.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                page_list.sh [-reset_run]
#                page_list.sh [-reset_log]
#                page_list.sh [-help]
#
...
#                script (type 'page_list.sh -help' for more information).
#
...
# script info
echo -e "page_list.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./page_list.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.page_list xil_defaultlib.glbl -o page_list_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./page_list_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key page_list_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc page_list_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./page_list.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: page_list.sh [-help]\n\
Usage: page_list.sh [-step]\n\
Usage: page_list.sh [-lib_map_path]\n\
Usage: page_list.sh [-reset_run]\n\
Usage: page_list.sh [-reset_log]\n\
Usage: page_list.sh [-keep_index]\n\
Usage: page_list.sh [-noclean_files]\n\n\
