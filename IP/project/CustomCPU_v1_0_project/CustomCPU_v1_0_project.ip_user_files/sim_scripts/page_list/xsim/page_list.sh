...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot page_list xil_defaultlib.page_list -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim page_list -key {Behavioral:sim_1:Functional:page_list} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb page_list.wdb xsim.dir libdpi.so)
