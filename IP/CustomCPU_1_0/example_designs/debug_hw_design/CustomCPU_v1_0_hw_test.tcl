# Runtime Tcl commands to interact with - CustomCPU_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/CustomCPU_v1_0_include.tcl
...
# Test: memory_bus
set wdata_memory_bus [get_init_data 0]
create_hw_axi_txn w_memory_bus_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_memory_bus}
create_hw_axi_txn r_memory_bus_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_memory_bus_addr
run_hw_axi w_memory_bus_addr
run_hw_axi r_memory_bus_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_memory_bus_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 1 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - memory_bus"
} else {
	puts "Data comparison test fail for - memory_bus, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
