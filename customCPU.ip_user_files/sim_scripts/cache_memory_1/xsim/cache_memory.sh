...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot cache_memory xil_defaultlib.cache_memory -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cache_memory -key {Behavioral:sim_1:Functional:cache_memory} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cache_memory.wdb xsim.dir libdpi.so)
