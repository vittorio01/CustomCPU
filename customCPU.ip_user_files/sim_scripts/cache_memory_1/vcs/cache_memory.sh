...
#
# Script generated by Vivado on Mon Jul 10 16:46:00 CEST 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : cache_memory.sh
...
#
# Usage        : cache_memory.sh
#                cache_memory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cache_memory.sh [-reset_run]
#                cache_memory.sh [-reset_log]
#                cache_memory.sh [-help]
#
...
#                script (type 'cache_memory.sh -help' for more information).
#
...
# script info
echo -e "cache_memory.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cache_memory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.cache_memory -o cache_memory_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./cache_memory_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key cache_memory_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc cache_memory_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cache_memory.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cache_memory.sh [-help]\n\
Usage: cache_memory.sh [-step]\n\
Usage: cache_memory.sh [-lib_map_path]\n\
Usage: cache_memory.sh [-reset_run]\n\
Usage: cache_memory.sh [-reset_log]\n\
Usage: cache_memory.sh [-keep_index]\n\
Usage: cache_memory.sh [-noclean_files]\n\n\
