...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot register_array xil_defaultlib.register_array -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim register_array -key {Behavioral:sim_1:Functional:register_array} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb register_array.wdb xsim.dir libdpi.so)
