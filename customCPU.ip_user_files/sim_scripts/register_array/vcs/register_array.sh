...
#
# Script generated by Vivado on Wed Jul 05 12:16:34 CEST 2023
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.register_array -o register_array_simv
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/vittorio/GitHub/CustomCPU/customCPU.cache/compile_simlib/vcs"
  fi
