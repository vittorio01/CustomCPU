...
HD_PWD='/home/vittorio/GitHub/CustomCPU/customCPU.runs/cache_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cache_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cache_memory.tcl
